                                ...
                                <div class="card m-2" style="width: 15rem;">
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <router-link :to="{name: 'restaurant', params: {slug: restaurant.slug, restaurant: restaurant}}" class="btn" style="background-color:#ff8906;" >Vai al ristorante</router-link>
                                        </div>
                                    </div>
                                </div>
                            </div>
